...
function Presentation (presentationPath) {
  ...
  presentation.textReplace = function (findString, replaceString) {
    nativePresentation.textReplace({'find': findString, 'replace': replaceString}, true)
    return presentation
  }
  ...
  presentation.activeSlide = function () {
